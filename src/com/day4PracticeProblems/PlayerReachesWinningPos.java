...
public class PlayerReachesWinningPos {
    ...
    public static void main(String[] args) {
        System.out.println("""
                ...
                """);
        PlayerReachesWinningPos referMethods = new PlayerReachesWinningPos();
            ...
            if (player1Position == 0) {
                ...
                switch (movementCase) {
                    ...
                    case 2 -> {
                        ...
                        System.out.println("\nSnake Bite...: " + "Player's position is " + player1Position+"\n");
                    }
                    default -> {
                        player1Position += rolledDice;
                        System.out.println("\nLadder jump...: " + "Player's position is " + player1Position + "\n");
                    }
                }
            }
        }
