...
public class PlayerWinsExact100_ {
    int startPosition = 0;
    ...
    public static void main(String[] args) {
        System.out.println("""
                ...
                """);
        PlayerWinsExact100_ referMethods = new PlayerWinsExact100_();
    ...
    public void GameStart() {
        ...
        System.out.println("\n\nPlayers Position is: " + player1Position + " & die rolled " + dieRollCounterP01 + " times.");
    }
}
